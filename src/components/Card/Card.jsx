...
const Card = ({
  ...
  return (
    <>
      <div className="w-full min-h-[650px] h-[650px] bg-white rounded-[20px] flex flex-col justify-between group hover:bg-green-500 flex-grow-0 flex-shrink-0 transition-all duration-500 ease-in-out box-borders">

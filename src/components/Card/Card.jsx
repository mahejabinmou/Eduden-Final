...
const Card = ({
    ...
    return (
        <>
            <div className="max-w-[385px] min-h-[650px] h-[650px] bg-white rounded-[20px] flex flex-col justify-between group hover:bg-green-500 flex-grow-0 flex-shrink-0 transition-all duration-500 ease-in-out box-borders">
                ...
                <div className="group-hover:hidden block transition-opacity duration-500 ease-in-out">
                    <div className="relative">
                        ...
                        />
                        <div className="w-[102px] h-[102px] rounded-full bg-black absolute bottom-0 flex items-center justify-center right-[35px] translate-y-1/2 font-bold text-[#93DF4C] font-gucina text-[35px]">
                            {price}
                        </div>
                    </div>
                    <div className="px-[25px] mt-[68px]">
                        <div>
                            <div className="flex items-center justify-between">
                                <p className="p-[5px] bg-black text-[20px] font-bold text-[#A8FF57] rounded-[50px]">
                                    {category}
                                </p>
                        ...
                        <div className="mt-[25px]">
                            ...
                            <p className="text-black font-[14px] mt-[15px] font-sans">
                                {description}
                            </p>
                        </div>
                    </div>
                        ...
                        <div>
                            <div className="mt-10 flex items-center justify-between ">
                                <TitleContainer
                                    title={"Enroll Now"}
                                    className={
                                        "px-[18px] py-2 bg-[#000] text-[#A8FF57] rounded-[50px] text-nowrap cursor-pointer transition-transform duration-500 ease-in-out hover:scale-105"
                                    }
                                    handler={() => {}}
                                />
                                <svg
                ...
                <div className="px-[25px]">
                    {slider && (
                        <div className="h-[1px] bg-[#010101] mb-[15px]"></div>
                    )}
                    <div
                        className={` mt-[22px] ${
                            slider

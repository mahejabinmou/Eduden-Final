            ...
            <div className="relative z-10 bg-white p-10 md:p-[50px] flex flex-col gap-[35px] items-center justify-center max-w-[920px] rounded-lg">
                ...
                <div className="flex gap-3 md:gap-5 flex-col md:flex-row">
                    <button
                        ...
                        className="px-[50px] py-[6px] bg-[#A8FF57] font-gucina text-[rgba(1, 1, 1, 0.80)] rounded-[50px] hover:bg-[#a8ff5769]"
                    >
                        Not Now
                    </button>
                    <button
                        onClick={() => setIsOkay(false)}
                        className="px-[50px] py-[6px] bg-[#A8FF57] font-gucina text-[rgba(1, 1, 1, 0.80)] flex items-center gap-3 rounded-[50px] hover:bg-[#a8ff5769]"
                    >
                        <FaDownload />{" "}

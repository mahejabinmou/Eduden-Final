...
const SearchCourses = () => {
  return (
    <div className=" flex justify-between items-center mt-[50px] mb-[30px] md:mb-[70px]">
      <div>
        <p className="text-white text-[8px] md:text-[14px]">
      ...
      <div className="max-w-[172px] md:max-w-[380px] coursesSrchBtn">
        <input
          type="Search courses"
          required
          className="w-full placeholder:text-[#FFFFFFCC] text-[12px] md:text-[18px] text-[#FFFFFFCC] md:px-[15px] md:py-[10px] rounded-[20px]"
          placeholder="Search courses "
        />
        {/* <button>Search</button> */}
      </div>

...
const OnlineCourses = () => {
    ...
    border border-[#A8FF57]"
			...
			<div className="sectionGap  grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4 items-center gap-[20px]">
				<div className="hover:bg-[#A8FF57B2]/[1] bg-[#141414] px-[30px] pt-[50px] group rounded-[20px] text-center relative overflow-hidden">
					{/* Full-screen overlay image */}
					<img
						src="card-hover.jpg"
						alt="Hovered Image"
						className="absolute inset-0 w-full h-full object-cover opacity-0 group-hover:opacity-50 transition-opacity duration-500 z-5"
						style={{
					...
					{/* SVG Container */}
					<div className="h-[60px] w-[60px] mx-auto xl:mb-[45px] lg:mb-[20px] mb-[20px] rounded-full bg-white group-hover:bg-[#000000] flex justify-center items-center z-10 relative">
						<svg
					...
					<h1 className="mb-[15px] aboutPageHero group-hover:text-[#000000] transition duration-500 relative z-10">
						Life Time Access
					</h1>
					<p className="xl:mb-[20px] lg:mb-[20px] joinClanSubPara px-[10px] group-hover:text-[#000000] transition duration-500 relative z-10">
						Lorem ipsum dolor sit amet conset ur elit sed eiusmod ex tempor inc
						labore dolore magna.
					</p>
					<div className="flex items-center justify-center pb-[30px] relative z-10">
						<svg
							xmlns="http://www.w3.org/2000/svg"
							viewBox="0 0 200 60"

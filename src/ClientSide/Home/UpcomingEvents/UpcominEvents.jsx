...
const UpcominEvents = () => {
    return (
        <div className="text-[#FFFFFF]  sectionGap mt-[100px] md:mt-0">
            <div>
                <h1 className="popularCategoryHead mb-[20px] md:mb-[45px] text-center">
                    {" "}
                    Upcoming{" "}
                    <span className="border-b-4 border-[#A8FF57]">Events</span>
                </h1>
                <p
      ...
      md:px-[10px] px-[10px] text-center"
                >
                    ...
                    Edu-Den, we’re the rebels of education, the mavericks of
                    learning, and the champions of fun-filled knowledge. We’ll
                    teach you how to slay dragons and code websites, all while
                ...
                <div className="rounded-[20px]  relative w-full h-[513px] overflow-hidden shadow-lg group">
                    ...
                    <div className="absolute inset-0 top-[277px]  flex flex-col justify-center items-center text-center opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                        ...
                        <p className="upcomingPara mb-[20px] lg:px-[50px] px-[20px]">
                            Fermentum fusce himenaeos neque condimentum maecenas
                            vitae congue iaculis inceptos ullamcorper habitasse
                        </p>
